...
import {
  ...
  type WorkflowCanvasRuntimeState,
  type WorkflowCanvasValidationIssue,
} from "../features/automation/WorkflowCanvas";
import type {
  AutomationBlock,
  AutomationBlockType,
  AutomationInboxItem,
...
function AttachedStampSettings({
  block,
  onAttachedChange,
  onAttachedRemove,
}: {
...
function defaultEditBlockConfig(
  type: AutomationBlockType,
  sources: DataSource[],
  addressBook: AddressBookEntry[],
): AutomationBlock["config"] {
...
function validationIssuesByBlockId(
  validation: AutomationValidationResult | null,
...
function runtimeByBlockIdFromRun(
...
function WatchRuntimeInspector({
  selectedBlock,
  latestBlockRun,
  selectedRun,
  validation,
...
function workflowMatchesFilter(
  workflow: AutomationWorkflow,
  search: string,
...
function defaultOutputBlockConfig(
  source: DataSource | undefined,
  durationMs: number,
): AutomationBlock["config"] {
...
function retargetOutputBlockConfig(
  config: AutomationBlock["config"],
...
function defaultVariableSourceConfig(
  config: AutomationBlock["config"],
...
function defaultConditionSourceConfig(
  config: AutomationBlock["config"],
...
function defaultPreviewFormatConfig(
  config: AutomationBlock["config"],
...
function previewContentModeConfig(
  config: AutomationBlock["config"],
...
function defaultPreviewContentText(
