...
import { eyebrowClass } from "../onboardingStyles";
...
export function WelcomeStep() {
  ...
  return (
    <OnboardingCard className="onboarding-enter gap-10 motion-safe:animate-[onboarding-fade-up_0.45s_ease-out_both] max-[700px]:gap-8">
      <header className="grid gap-4">
        <h3 id="welcome-ahead-heading" className={eyebrowClass}>
          Setup Guide
        </h3>
