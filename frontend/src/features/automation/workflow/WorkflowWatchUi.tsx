...
import type { AutomationBlock, AutomationRun, AutomationValidationResult, AutomationWorkflow } from "../automationTypes";
...
export function WorkflowValidationPanel({ validation }: { validation: AutomationValidationResult | null }) {
...
export function WatchRuntimeInspector({ selectedBlock, latestBlockRun, selectedRun, validation, onCloseSelectedBlock }: { selectedBlock: AutomationBlock | undefined; latestBlockRun: AutomationRun["blocks"][number] | null; selectedRun: AutomationRun | undefined; validation: AutomationValidationResult | null; onCloseSelectedBlock?: () => void }) {
...
export function WatchRunHistory({ runs, selectedRunId, onSelectRun }: { runs: AutomationRun[]; selectedRunId: string | null; onSelectRun: (runId: string) => void }) {
