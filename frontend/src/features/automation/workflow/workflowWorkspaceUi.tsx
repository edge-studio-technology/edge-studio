...
export function SelectedBlockSheet({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[70]">
      ...
      />
      <aside
        className="bg-surface-always-white border-stroke-secondary absolute inset-y-0 right-0 grid h-full min-h-0 w-full grid-cols-[minmax(0,1fr)] grid-rows-[auto_minmax(0,1fr)_auto] border-l shadow-[0_24px_60px_rgba(0,0,0,0.18)] lg:max-w-[400px]"
        role="dialog"
        aria-modal="true"
        aria-label={title}
      >
