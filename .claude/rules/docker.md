...
- BME280 sensor reads use the opt-in host-side Python sensor helper (`ENABLE_SENSORS=true`) instead of mounting `/dev/i2c-*` into the backend container; keep it token-protected, narrow, and documented as host I2C hardware access.
