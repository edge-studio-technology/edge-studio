...
Risk: `ENABLE_SENSORS=true` installs a host-side `integritas-pi-sensor-helper` service that can read supported I2C sensors such as BME280 through the Pi's I2C bus.
