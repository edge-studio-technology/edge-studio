...
- **Branch protection on `main`**: confirmed still off (`gh api repos/integritas-technology/edge-studio/branches/main/protection` → 404). Deferred pending an actual PR-based team workflow; revisit once that's in regular use.
