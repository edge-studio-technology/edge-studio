...
- #275: add draft screenshots slide by slide (Welcome, Dashboard, Minima, Wallet, and Integritas done, captured with Playwright at 1440×480 from dev data), then recapture every slide with clean, Pi-like values before merge; review the step copy.
