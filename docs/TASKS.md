...
- [ ] Manual browser check of `update-agent`'s static update-progress page (`/update/` during an in-progress apply) to confirm the new logo lockup renders correctly there.
